...
public partial class BfssematicKernelContext : DbContext
{
    public BfssematicKernelContext()
    {
    }

    public BfssematicKernelContext(DbContextOptions<BfssematicKernelContext> options)
        : base(options)
    {
    }
